...
public class HeroFactory {
    ...
    private static Hero buildBerserker() {
        Hero hero = new Hero("berserker", Ranks.ME, 22, 22, 13, 11, 6, 4, 0, 1, Hero.HeroTypes.STR_DEX);
    ...
    public static Hero buildDwarfWarrior() {
        Hero hero = new Hero("dwarf_warrior", Ranks.ME, 28, 28, 15, 6, 9, 3, 0, 1, Hero.HeroTypes.STR);
    ...
    private static Hero buildElfRanger() {
        Hero hero = new Hero("elf_ranger", Ranks.ME, 16, 16, 6, 13, 11, 5, 0, 1, Hero.HeroTypes.DEX_SPI);
    ...
    private static Hero buildWizard() {
        Hero hero = new Hero("wizard", Ranks.ME, 16, 16, 6, 10, 14, 4, 0, 1, Hero.HeroTypes.SPI);
    ...
    private static Hero buildDruid() {
        Hero hero = new Hero("druid", Ranks.ME, 18, 18, 11, 8, 11, 4, 0, 1, Hero.HeroTypes.STR_SPI);
        hero.equip(WeaponFactory.buildWizardStaff(0));
        hero.equip(ArmorFactory.buildLeatherVest(0));
    ...
    private static Hero buildThief() {
        Hero hero = new Hero("thief", Ranks.ME, 20, 20, 8, 14, 8, 5, 0, 1, Hero.HeroTypes.DEX);
