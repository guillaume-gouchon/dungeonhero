...
public class PNJFactory {
    ...
    public static Pnj buildPNJ() {
        Pnj pnj = new Pnj("princess", Ranks.NEUTRAL, 5, 5, 6, 10, 2, 7, 1, 500);
        ...
        pnj.getDiscussions().add(new Discussion(new OpenRiddle(10, "hello_riddle", "marron", new Reward(WeaponFactory.buildSword()))));
