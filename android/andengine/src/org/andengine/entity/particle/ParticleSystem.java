...
public class ParticleSystem<T extends IEntity> extends Entity {
    ...
    private final ArrayList<IParticleInitializer<T>> mParticleInitializers = new ArrayList<>();
    private final ArrayList<IParticleModifier<T>> mParticleModifiers = new ArrayList<>();
    ...
    ParticleSystem(final IEntityFactory<T> pEntityFactory, final IParticleEmitter pParticleEmitter, final float pRateMinimum, final float pRateMaximum, final int pParticlesMaximum) {
        this(0, 0, pEntityFactory, pParticleEmitter, pRateMinimum, pRateMaximum, pParticlesMaximum);
    }

    @SuppressWarnings("unchecked")
    ParticleSystem(final float pX, final float pY, final IEntityFactory<T> pEntityFactory, final IParticleEmitter pParticleEmitter, final float pRateMinimum, final float pRateMaximum, final int pParticlesMaximum) {
        super(pX, pY);
