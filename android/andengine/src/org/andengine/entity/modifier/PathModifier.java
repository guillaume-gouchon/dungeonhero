...
public class PathModifier extends EntityModifier {
    ...
    private PathModifier(final float pDuration, final Path pPath, final IEntityModifierListener pEntityModiferListener, final IPathModifierListener pPathModifierListener, final IEaseFunction pEaseFunction) throws IllegalArgumentException {
    ...
    private PathModifier(final PathModifier pPathModifier) throws DeepCopyNotSupportedException {
