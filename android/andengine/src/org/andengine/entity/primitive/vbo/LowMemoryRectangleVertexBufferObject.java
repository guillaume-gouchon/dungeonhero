...
public class LowMemoryRectangleVertexBufferObject extends LowMemoryVertexBufferObject implements IRectangleVertexBufferObject {
	...
	public void onUpdateColor(final Rectangle pRectangle) {
		...
		bufferData.put(Rectangle.COLOR_INDEX, packedColor);
		bufferData.put(Rectangle.VERTEX_SIZE + Rectangle.COLOR_INDEX, packedColor);
	...
	public void onUpdateVertices(final Rectangle pRectangle) {
		...
		bufferData.put(Rectangle.VERTEX_INDEX_X, x);
		bufferData.put(Rectangle.VERTEX_INDEX_Y, y);

		bufferData.put(Rectangle.VERTEX_SIZE + Rectangle.VERTEX_INDEX_X, x);
		bufferData.put(Rectangle.VERTEX_SIZE + Rectangle.VERTEX_INDEX_Y, y2);
