...
public class HighPerformanceLineVertexBufferObject extends HighPerformanceVertexBufferObject implements ILineVertexBufferObject {
	...
	public void onUpdateColor(final Line pLine) {
		...
		bufferData[Line.COLOR_INDEX] = packedColor;
		bufferData[Line.VERTEX_SIZE + Line.COLOR_INDEX] = packedColor;
	...
	public void onUpdateVertices(final Line pLine) {
		...
		bufferData[Line.VERTEX_INDEX_X] = 0;
		bufferData[Line.VERTEX_INDEX_Y] = 0;

		bufferData[Line.VERTEX_SIZE + Line.VERTEX_INDEX_X] = pLine.getX2() - pLine.getX1();
		bufferData[Line.VERTEX_SIZE + Line.VERTEX_INDEX_Y] = pLine.getY2() - pLine.getY1();
