...
public class LowMemoryLineVertexBufferObject extends LowMemoryVertexBufferObject implements ILineVertexBufferObject {
	...
	public void onUpdateColor(final Line pLine) {
		...
		bufferData.put(Line.COLOR_INDEX, packedColor);
		bufferData.put(Line.VERTEX_SIZE + Line.COLOR_INDEX, packedColor);
	...
	public void onUpdateVertices(final Line pLine) {
		...
		bufferData.put(Line.VERTEX_INDEX_X, 0);
		bufferData.put(Line.VERTEX_INDEX_Y, 0);

		bufferData.put(Line.VERTEX_SIZE + Line.VERTEX_INDEX_X, pLine.getX2() - pLine.getX1()); // TODO Optimize with field access?
		bufferData.put(Line.VERTEX_SIZE + Line.VERTEX_INDEX_Y, pLine.getY2() - pLine.getY1()); // TODO Optimize with field access?
