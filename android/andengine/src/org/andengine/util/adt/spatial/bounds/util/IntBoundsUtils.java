...
public final class IntBoundsUtils {
	...
	public static boolean contains(final IIntBounds pIntBounds, final int pX, final int pY) {
		return IntBoundsUtils.contains(pIntBounds.getXMin(), pIntBounds.getYMin(), pIntBounds.getXMax(), pIntBounds.getYMax(), pX, pY);
	}
	
	public static boolean contains(final IIntBounds pIntBounds, final int pXMin, final int pYMin, final int pXMax, final int pYMax) {
	...
	public static boolean contains(final int pXMin, final int pYMin, final int pXMax, final int pYMax, final int pX, final int pY) {
	...
	private static boolean adjacent(final int pXMinA, final int pYMinA, final int pXMaxA, final int pYMaxA, final int pXMinB, final int pYMinB, final int pXMaxB, final int pYMaxB) {
