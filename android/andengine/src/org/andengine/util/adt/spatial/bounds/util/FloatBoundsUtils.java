...
public final class FloatBoundsUtils {
	...
	public static boolean contains(final IFloatBounds pFloatBounds, final float pX, final float pY) {
	...
	public static boolean contains(final IFloatBounds pFloatBounds, final float pXMin, final float pYMin, final float pXMax, final float pYMax) {
	...
	public static boolean contains(final float pXMin, final float pYMin, final float pXMax, final float pYMax, final float pX, final float pY) {
